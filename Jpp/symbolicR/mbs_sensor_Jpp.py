...
# Sensor Kinematics
  ...
  if (isens == 1): 
    ...
    ROcp1_110 = ROcp1_16*C10+ROcp1_49*S10
    ROcp1_210 = ROcp1_26*C10+ROcp1_59*S10
    ROcp1_310 = ROcp1_36*C10+ROcp1_69*S10
    ROcp1_410 = -ROcp1_16*S10+ROcp1_49*C10
    ROcp1_510 = -ROcp1_26*S10+ROcp1_59*C10
    ROcp1_610 = -ROcp1_36*S10+ROcp1_69*C10
  ...
  if (isens == 2): 
    ...
    ROcp2_116 = ROcp2_16*C16+ROcp2_415*S16
    ROcp2_216 = ROcp2_26*C16+ROcp2_515*S16
    ROcp2_316 = ROcp2_36*C16+ROcp2_615*S16
    ROcp2_416 = -ROcp2_16*S16+ROcp2_415*C16
    ROcp2_516 = -ROcp2_26*S16+ROcp2_515*C16
    ROcp2_616 = -ROcp2_36*S16+ROcp2_615*C16
    ...
    RLcp2_18 = ROcp2_413*s.dpt[2,22]
    RLcp2_28 = ROcp2_513*s.dpt[2,22]
    RLcp2_38 = ROcp2_613*s.dpt[2,22]
    ...
    RLcp2_19 = ROcp2_414*s.dpt[2,25]+ROcp2_714*s.dpt[3,25]
    RLcp2_29 = ROcp2_514*s.dpt[2,25]+ROcp2_814*s.dpt[3,25]
    RLcp2_39 = ROcp2_614*s.dpt[2,25]+ROcp2_914*s.dpt[3,25]
    POcp2_19 = POcp2_18+RLcp2_19
    POcp2_29 = POcp2_28+RLcp2_29
    POcp2_39 = POcp2_38+RLcp2_39
    OMcp2_19 = OMcp2_18+ROcp2_16*qd[15]
    OMcp2_29 = OMcp2_28+ROcp2_26*qd[15]
    OMcp2_39 = OMcp2_38+ROcp2_36*qd[15]
    ...
    OPcp2_19 = OPcp2_18+ROcp2_16*qdd[15]+qd[15]*(OMcp2_28*ROcp2_36-OMcp2_38*ROcp2_26)
    OPcp2_29 = OPcp2_28+ROcp2_26*qdd[15]+qd[15]*(-OMcp2_18*ROcp2_36+OMcp2_38*ROcp2_16)
    OPcp2_39 = OPcp2_38+ROcp2_36*qdd[15]+qd[15]*(OMcp2_18*ROcp2_26-OMcp2_28*ROcp2_16)
    ...
    OMcp2_110 = OMcp2_19+ROcp2_715*qd[16]
    OMcp2_210 = OMcp2_29+ROcp2_815*qd[16]
    OMcp2_310 = OMcp2_39+ROcp2_915*qd[16]
    OPcp2_110 = OPcp2_19+ROcp2_715*qdd[16]+qd[16]*(OMcp2_29*ROcp2_915-OMcp2_39*ROcp2_815)
    OPcp2_210 = OPcp2_29+ROcp2_815*qdd[16]+qd[16]*(-OMcp2_19*ROcp2_915+OMcp2_39*ROcp2_715)
    OPcp2_310 = OPcp2_39+ROcp2_915*qdd[16]+qd[16]*(OMcp2_19*ROcp2_815-OMcp2_29*ROcp2_715)
  ...
  if (isens == 3): 
    ...
    RLcp3_113 = ROcp3_424*s.dpt[2,34]
    RLcp3_213 = ROcp3_524*s.dpt[2,34]
    RLcp3_313 = ROcp3_624*s.dpt[2,34]
  ...
  if (isens == 4): 
    ...
    RLcp4_113 = ROcp4_424*s.dpt[2,35]
    RLcp4_213 = ROcp4_524*s.dpt[2,35]
    RLcp4_313 = ROcp4_624*s.dpt[2,35]
