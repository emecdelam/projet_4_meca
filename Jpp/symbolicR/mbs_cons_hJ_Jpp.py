...
# Constraints and Constraints Jacobian
    ...
    POlp2_12 = q[20]+s.dpt[1,14]
    RLlp2_17 = ROlp2_46*s.dpt[2,39]+s.dpt[3,39]*S23
    RLlp2_27 = ROlp2_56*s.dpt[2,39]+ROlp2_85*s.dpt[3,39]
    RLlp2_37 = ROlp2_66*s.dpt[2,39]+ROlp2_95*s.dpt[3,39]
    ...
    RLlp2_18 = ROlp2_17*s.dpt[1,51]
    RLlp2_28 = ROlp2_27*s.dpt[1,51]
    RLlp2_38 = ROlp2_37*s.dpt[1,51]
    ...
    h_1 = -POlp2_18+s.dpt[1,10]
    h_2 = -POlp2_28+s.dpt[2,10]
    h_3 = -POlp2_38+s.dpt[3,10]
    ROlp3_25 = S22*S23
    ROlp3_35 = -C22*S23
    ROlp3_85 = -S22*C23
    ROlp3_95 = C22*C23
    ...
    POlp3_12 = q[20]+s.dpt[1,14]
    RLlp3_17 = ROlp3_46*s.dpt[2,42]+s.dpt[3,42]*S23
    RLlp3_27 = ROlp3_56*s.dpt[2,42]+ROlp3_85*s.dpt[3,42]
    RLlp3_37 = ROlp3_66*s.dpt[2,42]+ROlp3_95*s.dpt[3,42]
    ...
    RLlp3_18 = ROlp3_17*s.dpt[1,52]
    RLlp3_28 = ROlp3_27*s.dpt[1,52]
    RLlp3_38 = ROlp3_37*s.dpt[1,52]
    ...
    h_4 = POlp3_18-s.dpt[1,11]
    h_5 = POlp3_28-s.dpt[2,11]
    h_6 = POlp3_38-s.dpt[3,11]
    RLlp5_22 = s.dpt[2,29]*C12
    RLlp5_32 = s.dpt[2,29]*S12
    POlp5_22 = RLlp5_22+s.dpt[2,3]
    POlp5_32 = RLlp5_32+s.dpt[3,3]
    ROlp6_82 = -C7*S8-S7*C8
    ROlp6_92 = C7*C8-S7*S8
    RLlp6_22 = s.dpt[2,23]*C7
    RLlp6_32 = s.dpt[2,23]*S7
    POlp6_22 = RLlp6_22+s.dpt[2,2]
    RLlp6_24 = ROlp6_82*s.dpt[3,25]
    RLlp6_34 = ROlp6_92*s.dpt[3,25]
    ...
    h_7 = -s.dpt[1,2]+s.dpt[1,3]
    h_8 = POlp5_22-POlp6_24
    h_9 = POlp5_32-POlp6_34
    ROlp7_82 = -C13*S14-S13*C14
    ROlp7_92 = C13*C14-S13*S14
    RLlp7_22 = s.dpt[2,30]*C13
    RLlp7_32 = s.dpt[2,30]*S13
    POlp7_22 = RLlp7_22+s.dpt[2,5]
    RLlp7_24 = ROlp7_82*s.dpt[3,32]
    RLlp7_34 = ROlp7_92*s.dpt[3,32]
    ...
    RLlp8_22 = s.dpt[2,36]*C18
    RLlp8_32 = s.dpt[2,36]*S18
    POlp8_22 = RLlp8_22+s.dpt[2,6]
    POlp8_32 = RLlp8_32+s.dpt[3,6]
    h_10 = s.dpt[1,5]-s.dpt[1,6]
    h_11 = POlp7_24-POlp8_22
    h_12 = POlp7_34-POlp8_32
    RLlp9_12 = s.dpt[1,56]*C29-s.dpt[2,56]*S29
    RLlp9_22 = s.dpt[1,56]*S29+s.dpt[2,56]*C29
    POlp9_12 = RLlp9_12+s.dpt[1,17]
    POlp9_22 = RLlp9_22+s.dpt[2,17]
    RLlp10_12 = s.dpt[1,58]*C30-s.dpt[2,58]*S30
    RLlp10_22 = s.dpt[1,58]*S30+s.dpt[2,58]*C30
    POlp10_12 = RLlp10_12+s.dpt[1,18]
    POlp10_22 = RLlp10_22+s.dpt[2,18]
    ...
    RLlp11_22 = s.dpt[2,23]*C7
    RLlp11_32 = s.dpt[2,23]*S7
    POlp11_22 = RLlp11_22+s.dpt[2,2]
    RLlp11_14 = s.dpt[1,27]*C9
    RLlp11_24 = ROlp11_23*s.dpt[1,27]
    RLlp11_34 = ROlp11_33*s.dpt[1,27]
    POlp11_14 = RLlp11_14+s.dpt[1,2]
    ...
    RLlp12_12 = s.dpt[1,55]*C29-s.dpt[2,55]*S29
    RLlp12_22 = s.dpt[1,55]*S29+s.dpt[2,55]*C29
    POlp12_12 = RLlp12_12+s.dpt[1,17]
    POlp12_22 = RLlp12_22+s.dpt[2,17]
    ...
    RLlp13_12 = s.dpt[1,57]*C30-s.dpt[2,57]*S30
    RLlp13_22 = s.dpt[1,57]*S30+s.dpt[2,57]*C30
    POlp13_12 = RLlp13_12+s.dpt[1,18]
    POlp13_22 = RLlp13_22+s.dpt[2,18]
    ...
    RLlp14_22 = s.dpt[2,30]*C13
    RLlp14_32 = s.dpt[2,30]*S13
    POlp14_22 = RLlp14_22+s.dpt[2,5]
    RLlp14_14 = s.dpt[1,34]*C15
    RLlp14_24 = ROlp14_23*s.dpt[1,34]
    RLlp14_34 = ROlp14_33*s.dpt[1,34]
    POlp14_14 = RLlp14_14+s.dpt[1,5]
