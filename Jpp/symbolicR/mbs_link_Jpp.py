...
# Link anchor points Kinematics
    ...
    RLlnk2_22 = s.dpt[2,23]*C7-s.dpt[3,23]*S7
    RLlnk2_32 = s.dpt[2,23]*S7+s.dpt[3,23]*C7
    ...
    RLlnk4_22 = s.dpt[2,30]*C13-s.dpt[3,30]*S13
    RLlnk4_32 = s.dpt[2,30]*S13+s.dpt[3,30]*C13
    ...
    RLlnk6_17 = ROlnk6_124*s.dpt[1,36]+ROlnk6_424*s.dpt[2,36]
    RLlnk6_27 = ROlnk6_224*s.dpt[1,36]+ROlnk6_524*s.dpt[2,36]
    RLlnk6_37 = ROlnk6_324*s.dpt[1,36]+ROlnk6_624*s.dpt[2,36]
    ...
    RLlnk8_17 = ROlnk8_124*s.dpt[1,37]+ROlnk8_424*s.dpt[2,37]
    RLlnk8_27 = ROlnk8_224*s.dpt[1,37]+ROlnk8_524*s.dpt[2,37]
    RLlnk8_37 = ROlnk8_324*s.dpt[1,37]+ROlnk8_624*s.dpt[2,37]
    ...
    RLlnk10_17 = ROlnk10_124*s.dpt[1,39]+ROlnk10_424*s.dpt[2,39]
    RLlnk10_27 = ROlnk10_224*s.dpt[1,39]+ROlnk10_524*s.dpt[2,39]
    RLlnk10_37 = ROlnk10_324*s.dpt[1,39]+ROlnk10_624*s.dpt[2,39]
    ...
    RLlnk12_17 = ROlnk12_124*s.dpt[1,40]+ROlnk12_424*s.dpt[2,40]
    RLlnk12_27 = ROlnk12_224*s.dpt[1,40]+ROlnk12_524*s.dpt[2,40]
    RLlnk12_37 = ROlnk12_324*s.dpt[1,40]+ROlnk12_624*s.dpt[2,40]
    ...
    RLlnk14_17 = ROlnk14_424*s.dpt[2,45]
    RLlnk14_27 = ROlnk14_524*s.dpt[2,45]
    RLlnk14_37 = ROlnk14_624*s.dpt[2,45]
    ...
    RLlnk16_17 = ROlnk16_424*s.dpt[2,44]
    RLlnk16_27 = ROlnk16_524*s.dpt[2,44]
    RLlnk16_37 = ROlnk16_624*s.dpt[2,44]
    ...
    RLlnk18_17 = ROlnk18_124*s.dpt[1,47]+ROlnk18_424*s.dpt[2,47]
    RLlnk18_27 = ROlnk18_224*s.dpt[1,47]+ROlnk18_524*s.dpt[2,47]
    RLlnk18_37 = ROlnk18_324*s.dpt[1,47]+ROlnk18_624*s.dpt[2,47]
    ...
    Plnk19 = POlnk18_17-s.dpt[1,18]
    Plnk29 = POlnk18_27-s.dpt[2,18]
    Plnk39 = POlnk18_37-s.dpt[3,18]
    ...
    RLlnk20_17 = ROlnk20_124*s.dpt[1,46]+ROlnk20_424*s.dpt[2,46]
    RLlnk20_27 = ROlnk20_224*s.dpt[1,46]+ROlnk20_524*s.dpt[2,46]
    RLlnk20_37 = ROlnk20_324*s.dpt[1,46]+ROlnk20_624*s.dpt[2,46]
    ...
    Plnk110 = POlnk20_17-s.dpt[1,20]
    Plnk210 = POlnk20_27-s.dpt[2,20]
    Plnk310 = POlnk20_37-s.dpt[3,20]
    ...
    RLlnk22_17 = ROlnk22_124*s.dpt[1,48]+ROlnk22_424*s.dpt[2,48]
    RLlnk22_27 = ROlnk22_224*s.dpt[1,48]+ROlnk22_524*s.dpt[2,48]
    RLlnk22_37 = ROlnk22_324*s.dpt[1,48]+ROlnk22_624*s.dpt[2,48]
    ...
    Plnk111 = POlnk22_17-s.dpt[1,19]
    Plnk211 = POlnk22_27-s.dpt[2,19]
    Plnk311 = POlnk22_37-s.dpt[3,19]
    ...
    RLlnk23_17 = ROlnk23_124*s.dpt[1,49]+ROlnk23_424*s.dpt[2,49]
    RLlnk23_27 = ROlnk23_224*s.dpt[1,49]+ROlnk23_524*s.dpt[2,49]
    RLlnk23_37 = ROlnk23_324*s.dpt[1,49]+ROlnk23_624*s.dpt[2,49]
    ...
    Plnk112 = -POlnk23_17+s.dpt[1,21]
    Plnk212 = -POlnk23_27+s.dpt[2,21]
    Plnk312 = -POlnk23_37+s.dpt[3,21]
...
# Link Dynamics: forces projection on body-fixed frames
    ...
    trqlnk7_1_1 = fSlnk21*s.dpt[3,23]-fSlnk31*s.dpt[2,23]
    trqlnk7_1_2 = -fSlnk11*s.dpt[3,23]
    trqlnk7_1_3 = fSlnk11*s.dpt[2,23]
    fPlnk12 = Flink2*e12
    fPlnk22 = Flink2*e22
    fPlnk32 = Flink2*e32
    ...
    trqlnk13_2_1 = fSlnk22*s.dpt[3,30]-fSlnk32*s.dpt[2,30]
    trqlnk13_2_2 = -fSlnk12*s.dpt[3,30]
    trqlnk13_2_3 = fSlnk12*s.dpt[2,30]
    fPlnk13 = Flink3*e13
    fPlnk23 = Flink3*e23
    fPlnk33 = Flink3*e33
    ...
    trqlnk24_3_1 = -fSlnk33*s.dpt[2,36]
    trqlnk24_3_2 = fSlnk33*s.dpt[1,36]
    trqlnk24_3_3 = fSlnk13*s.dpt[2,36]-fSlnk23*s.dpt[1,36]
    fPlnk14 = Flink4*e14
    fPlnk24 = Flink4*e24
    fPlnk34 = Flink4*e34
    ...
    trqlnk24_4_1 = trqlnk24_3_1-fSlnk34*s.dpt[2,37]
    trqlnk24_4_2 = trqlnk24_3_2+fSlnk34*s.dpt[1,37]
    trqlnk24_4_3 = trqlnk24_3_3+fSlnk14*s.dpt[2,37]-fSlnk24*s.dpt[1,37]
    fPlnk15 = Flink5*e15
    fPlnk25 = Flink5*e25
    fPlnk35 = Flink5*e35
    ...
    trqlnk24_5_1 = trqlnk24_4_1-fSlnk35*s.dpt[2,39]
    trqlnk24_5_2 = trqlnk24_4_2+fSlnk35*s.dpt[1,39]
    trqlnk24_5_3 = trqlnk24_4_3+fSlnk15*s.dpt[2,39]-fSlnk25*s.dpt[1,39]
    fPlnk16 = Flink6*e16
    fPlnk26 = Flink6*e26
    fPlnk36 = Flink6*e36
    ...
    trqlnk24_6_1 = trqlnk24_5_1-fSlnk36*s.dpt[2,40]
    trqlnk24_6_2 = trqlnk24_5_2+fSlnk36*s.dpt[1,40]
    trqlnk24_6_3 = trqlnk24_5_3+fSlnk16*s.dpt[2,40]-fSlnk26*s.dpt[1,40]
    fPlnk17 = Flink7*e17
    fPlnk27 = Flink7*e27
    fPlnk37 = Flink7*e37
    ...
    trqlnk24_7_1 = trqlnk24_6_1-fSlnk37*s.dpt[2,45]
    trqlnk24_7_3 = trqlnk24_6_3+fSlnk17*s.dpt[2,45]
    fPlnk18 = Flink8*e18
    fPlnk28 = Flink8*e28
    fPlnk38 = Flink8*e38
    ...
    trqlnk24_8_1 = trqlnk24_7_1-fSlnk38*s.dpt[2,44]
    trqlnk24_8_3 = trqlnk24_7_3+fSlnk18*s.dpt[2,44]
    fPlnk19 = Flink9*e19
    fPlnk29 = Flink9*e29
    fPlnk39 = Flink9*e39
    ...
    trqlnk6_9_1 = trqlnk6_8_1-fPlnk29*s.dpt[3,18]+fPlnk39*s.dpt[2,18]
    trqlnk6_9_2 = trqlnk6_8_2+fPlnk19*s.dpt[3,18]-fPlnk39*s.dpt[1,18]
    ...
    trqlnk24_9_1 = trqlnk24_8_1-fSlnk39*s.dpt[2,47]
    trqlnk24_9_2 = trqlnk24_6_2+fSlnk39*s.dpt[1,47]
    trqlnk24_9_3 = trqlnk24_8_3+fSlnk19*s.dpt[2,47]-fSlnk29*s.dpt[1,47]
    ...
    trqlnk6_10_1 = trqlnk6_9_1-fPlnk210*s.dpt[3,20]+fPlnk310*s.dpt[2,20]
    trqlnk6_10_2 = trqlnk6_9_2+fPlnk110*s.dpt[3,20]-fPlnk310*s.dpt[1,20]
    trqlnk6_10_3 = trqlnk6_9_3-fPlnk110*s.dpt[2,20]+fPlnk210*s.dpt[1,20]
    ...
    trqlnk24_10_1 = trqlnk24_9_1-fSlnk310*s.dpt[2,46]
    trqlnk24_10_2 = trqlnk24_9_2+fSlnk310*s.dpt[1,46]
    trqlnk24_10_3 = trqlnk24_9_3+fSlnk110*s.dpt[2,46]-fSlnk210*s.dpt[1,46]
    ...
    trqlnk6_11_1 = trqlnk6_10_1-fPlnk211*s.dpt[3,19]+fPlnk311*s.dpt[2,19]
    trqlnk6_11_2 = trqlnk6_10_2+fPlnk111*s.dpt[3,19]-fPlnk311*s.dpt[1,19]
    trqlnk6_11_3 = trqlnk6_10_3-fPlnk111*s.dpt[2,19]+fPlnk211*s.dpt[1,19]
    ...
    trqlnk24_11_1 = trqlnk24_10_1-fSlnk311*s.dpt[2,48]
    trqlnk24_11_2 = trqlnk24_10_2+fSlnk311*s.dpt[1,48]
    trqlnk24_11_3 = trqlnk24_10_3+fSlnk111*s.dpt[2,48]-fSlnk211*s.dpt[1,48]
    ...
    trqlnk24_12_1 = trqlnk24_11_1+fPlnk312*s.dpt[2,49]
    trqlnk24_12_2 = trqlnk24_11_2-fPlnk312*s.dpt[1,49]
    trqlnk24_12_3 = trqlnk24_11_3-fPlnk112*s.dpt[2,49]+fPlnk212*s.dpt[1,49]
    ...
    trqlnk6_12_1 = trqlnk6_11_1+fSlnk212*s.dpt[3,21]-fSlnk312*s.dpt[2,21]
    trqlnk6_12_2 = trqlnk6_11_2-fSlnk112*s.dpt[3,21]+fSlnk312*s.dpt[1,21]
    trqlnk6_12_3 = trqlnk6_11_3+fSlnk112*s.dpt[2,21]-fSlnk212*s.dpt[1,21]
