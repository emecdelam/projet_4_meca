...
# Forward Kinematics
    ...
    ALPHA111 = ALPHA110*C11-ALPHA39*S11
    ALPHA311 = ALPHA110*S11+ALPHA39*C11
    OM112 = qd[12]+OM16
    ...
    ALPHA115 = ALPHA114+BETA214*s.dpt[2,25]+BETA314*s.dpt[3,25]
    ALPHA215 = C15*(ALPHA214+BETA614*s.dpt[3,25]+BS514*s.dpt[2,25])+S15*(ALPHA314+BETA814*s.dpt[2,25]+BS914*s.dpt[3,25])
    ALPHA315 = C15*(ALPHA314+BETA814*s.dpt[2,25]+BS914*s.dpt[3,25])-S15*(ALPHA214+BETA614*s.dpt[3,25]+BS514*s.dpt[2,25])
    ...
    ALPHA117 = ALPHA116*C17-ALPHA315*S17
    ALPHA317 = ALPHA116*S17+ALPHA315*C17
    OM118 = qd[18]+OM16
    ...
    ALPHA125 = C25*(ALPHA124+BETA224*s.dpt[2,30]+BETA324*s.dpt[3,30])-S25*(ALPHA323+BETA824*s.dpt[2,30]+BS924*s.dpt[3,30])
    ALPHA225 = ALPHA224+BETA624*s.dpt[3,30]+BS524*s.dpt[2,30]
    ALPHA325 = C25*(ALPHA323+BETA824*s.dpt[2,30]+BS924*s.dpt[3,30])+S25*(ALPHA124+BETA224*s.dpt[2,30]+BETA324*s.dpt[3,30])
    ...
    ALPHA126 = C26*(ALPHA124+BETA224*s.dpt[2,33]+BETA324*s.dpt[3,33])-S26*(ALPHA323+BETA824*s.dpt[2,33]+BS924*s.dpt[3,33])
    ALPHA226 = ALPHA224+BETA624*s.dpt[3,33]+BS524*s.dpt[2,33]
    ALPHA326 = C26*(ALPHA323+BETA824*s.dpt[2,33]+BS924*s.dpt[3,33])+S26*(ALPHA124+BETA224*s.dpt[2,33]+BETA324*s.dpt[3,33])
    ...
    ALPHA127 = C27*(ALPHA124+BETA224*s.dpt[2,34])-S27*(ALPHA323+BETA824*s.dpt[2,34])
    ALPHA227 = ALPHA224+BS524*s.dpt[2,34]
    ALPHA327 = C27*(ALPHA323+BETA824*s.dpt[2,34])+S27*(ALPHA124+BETA224*s.dpt[2,34])
    ...
    ALPHA128 = C28*(ALPHA124+BETA224*s.dpt[2,35])-S28*(ALPHA323+BETA824*s.dpt[2,35])
    ALPHA228 = ALPHA224+BS524*s.dpt[2,35]
    ALPHA328 = C28*(ALPHA323+BETA824*s.dpt[2,35])+S28*(ALPHA124+BETA224*s.dpt[2,35])
...
# Backward Dynamics
    ...
    Cq124 = -s.trq[1,24]+s.In[1,24]*OMp124-s.In[5,24]*OM224*OM324+s.In[9,24]*OM224*OM324+Cq125*C25+Cq126*C26+Cq127*C27+Cq128*C28+Cq325*S25+Cq326*S26+Cq327*S27+Cq328*S28-Fs225*s.dpt[3,30]-Fs226*s.dpt[3,33]+s.dpt[2,30]*(-Fs125*S25+Fs325*C25)+s.dpt[2,33]*(-Fs126*S26+Fs326*C26)+s.dpt[2,34]*(-Fs127*S27+Fs327*C27)+s.dpt[2,35]*(-Fs128*S28+Fs328*C28)
    Cq224 = -s.trq[2,24]+Cq225+Cq226+Cq227+Cq228+s.In[1,24]*OM124*OM324+s.In[5,24]*OMp224-s.In[9,24]*OM124*OM324+s.dpt[3,30]*(Fs125*C25+Fs325*S25)+s.dpt[3,33]*(Fs126*C26+Fs326*S26)
    Cq324 = -s.trq[3,24]-s.In[1,24]*OM124*OM224+s.In[5,24]*OM124*OM224+s.In[9,24]*OMp324-Cq125*S25-Cq126*S26-Cq127*S27-Cq128*S28+Cq325*C25+Cq326*C26+Cq327*C27+Cq328*C28-s.dpt[2,30]*(Fs125*C25+Fs325*S25)-s.dpt[2,33]*(Fs126*C26+Fs326*S26)-s.dpt[2,34]*(Fs127*C27+Fs327*S27)-s.dpt[2,35]*(Fs128*C28+Fs328*S28)
    ...
    Fq115 = Fq116*C16-Fs217*S16
    Fq215 = Fq116*S16+Fs217*C16
    Cq115 = Cq116*C16-Cq217*S16
    Cq215 = Cq116*S16+Cq217*C16
    ...
    Cq114 = -s.trq[1,14]+Cq115+s.In[1,14]*OMp114-s.In[5,14]*OM214*OM314+s.In[9,14]*OM214*OM314+s.dpt[2,25]*(Fq215*S15+Fq316*C15)-s.dpt[3,25]*(Fq215*C15-Fq316*S15)
    Cq214 = -s.trq[2,14]+s.In[1,14]*OM114*OM314+s.In[5,14]*OMp214-s.In[9,14]*OM114*OM314+Cq215*C15-Cq316*S15+Fq115*s.dpt[3,25]
    Cq314 = -s.trq[3,14]-s.In[1,14]*OM114*OM214+s.In[5,14]*OM114*OM214+s.In[9,14]*OMp314+Cq215*S15+Cq316*C15-Fq115*s.dpt[2,25]
    ...
    Cq113 = -s.trq[1,13]+Cq114+s.In[1,13]*OMp113-s.In[5,13]*OM213*OM313+s.In[9,13]*OM213*OM313+s.dpt[2,22]*(Fq214*S14+Fq314*C14)
    Cq213 = -s.trq[2,13]+s.In[1,13]*OM113*OM313+s.In[5,13]*OMp213-s.In[9,13]*OM113*OM313+Cq214*C14-Cq314*S14
    Cq313 = -s.trq[3,13]-s.In[1,13]*OM113*OM213+s.In[5,13]*OM113*OM213+s.In[9,13]*OMp313+Cq214*S14+Cq314*C14-Fq114*s.dpt[2,22]
    ...
    Fq19 = Fq110*C10-Fs211*S10
    Fq29 = Fq110*S10+Fs211*C10
    Cq19 = Cq110*C10-Cq211*S10
    Cq29 = Cq110*S10+Cq211*C10
    ...
    Cq18 = -s.trq[1,8]+Cq19+s.In[1,8]*OMp18-s.In[5,8]*OM28*OM38+s.In[9,8]*OM28*OM38+s.dpt[2,19]*(Fq29*S9+Fq310*C9)-s.dpt[3,19]*(Fq29*C9-Fq310*S9)
    Cq28 = -s.trq[2,8]+s.In[1,8]*OM18*OM38+s.In[5,8]*OMp28-s.In[9,8]*OM18*OM38+Cq29*C9-Cq310*S9+Fq19*s.dpt[3,19]
    Cq38 = -s.trq[3,8]-s.In[1,8]*OM18*OM28+s.In[5,8]*OM18*OM28+s.In[9,8]*OMp38+Cq29*S9+Cq310*C9-Fq19*s.dpt[2,19]
