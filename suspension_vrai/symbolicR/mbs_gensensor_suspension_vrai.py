...
# Sensor Kinematics
  ...
  if (isens == 7): 
    ...
    RLcp7_17 = ROcp7_16*s.dpt[1,2]+s.dpt[3,2]*S5
    RLcp7_27 = ROcp7_26*s.dpt[1,2]+ROcp7_85*s.dpt[3,2]
    RLcp7_37 = ROcp7_36*s.dpt[1,2]+ROcp7_95*s.dpt[3,2]
  ...
  if (isens == 8): 
    ...
    ROcp8_18 = ROcp8_16*C8-S5*S8
    ROcp8_28 = ROcp8_26*C8-ROcp8_85*S8
    ROcp8_38 = ROcp8_36*C8-ROcp8_95*S8
    ROcp8_78 = ROcp8_16*S8+S5*C8
    ROcp8_88 = ROcp8_26*S8+ROcp8_85*C8
    ROcp8_98 = ROcp8_36*S8+ROcp8_95*C8
    OMcp8_25 = qd[5]*C4
    OMcp8_35 = qd[5]*S4
    ...
    OMcp8_17 = OMcp8_16+ROcp8_46*qd[8]
    OMcp8_27 = OMcp8_26+ROcp8_56*qd[8]
    OMcp8_37 = OMcp8_36+ROcp8_66*qd[8]
    ...
    OPcp8_17 = OPcp8_16+ROcp8_46*qdd[8]+qd[8]*(OMcp8_26*ROcp8_66-OMcp8_36*ROcp8_56)
    OPcp8_27 = OPcp8_26+ROcp8_56*qdd[8]+qd[8]*(-OMcp8_16*ROcp8_66+OMcp8_36*ROcp8_46)
    OPcp8_37 = OPcp8_36+ROcp8_66*qdd[8]+qd[8]*(OMcp8_16*ROcp8_56-OMcp8_26*ROcp8_46)
  ...
  if (isens == 9): 
    ...
    ROcp9_18 = ROcp9_16*C8-S5*S8
    ROcp9_28 = ROcp9_26*C8-ROcp9_85*S8
    ROcp9_38 = ROcp9_36*C8-ROcp9_95*S8
    ROcp9_78 = ROcp9_16*S8+S5*C8
    ROcp9_88 = ROcp9_26*S8+ROcp9_85*C8
    ROcp9_98 = ROcp9_36*S8+ROcp9_95*C8
    ...
    RLcp9_17 = ROcp9_16*s.dpt[1,3]
    RLcp9_27 = ROcp9_26*s.dpt[1,3]
    RLcp9_37 = ROcp9_36*s.dpt[1,3]
    ...
    OMcp9_17 = OMcp9_16+ROcp9_46*qd[8]
    OMcp9_27 = OMcp9_26+ROcp9_56*qd[8]
    OMcp9_37 = OMcp9_36+ROcp9_66*qd[8]
    ...
    OPcp9_17 = OPcp9_16+ROcp9_46*qdd[8]+qd[8]*(OMcp9_26*ROcp9_66-OMcp9_36*ROcp9_56)
    OPcp9_27 = OPcp9_26+ROcp9_56*qdd[8]+qd[8]*(-OMcp9_16*ROcp9_66+OMcp9_36*ROcp9_46)
    OPcp9_37 = OPcp9_36+ROcp9_66*qdd[8]+qd[8]*(OMcp9_16*ROcp9_56-OMcp9_26*ROcp9_46)
    ...
    RLcp9_18 = ROcp9_18*s.dpt[1,5]
    RLcp9_28 = ROcp9_28*s.dpt[1,5]
    RLcp9_38 = ROcp9_38*s.dpt[1,5]
    ...
    OMcp9_18 = OMcp9_17+ROcp9_46*qd[9]
    OMcp9_28 = OMcp9_27+ROcp9_56*qd[9]
    OMcp9_38 = OMcp9_37+ROcp9_66*qd[9]
    ...
    OPcp9_18 = OPcp9_17+ROcp9_46*qdd[9]+qd[9]*(OMcp9_27*ROcp9_66-OMcp9_37*ROcp9_56)
    OPcp9_28 = OPcp9_27+ROcp9_56*qdd[9]+qd[9]*(-OMcp9_17*ROcp9_66+OMcp9_37*ROcp9_46)
    OPcp9_38 = OPcp9_37+ROcp9_66*qdd[9]+qd[9]*(OMcp9_17*ROcp9_56-OMcp9_27*ROcp9_46)
  ...
  if (isens == 10): 
    ...
    ROcp10_18 = ROcp10_16*C8-S5*S8
    ROcp10_28 = ROcp10_26*C8-ROcp10_85*S8
    ROcp10_38 = ROcp10_36*C8-ROcp10_95*S8
    ROcp10_78 = ROcp10_16*S8+S5*C8
    ROcp10_88 = ROcp10_26*S8+ROcp10_85*C8
    ROcp10_98 = ROcp10_36*S8+ROcp10_95*C8
    ...
    RLcp10_17 = ROcp10_16*s.dpt[1,3]
    RLcp10_27 = ROcp10_26*s.dpt[1,3]
    RLcp10_37 = ROcp10_36*s.dpt[1,3]
    ...
    OMcp10_17 = OMcp10_16+ROcp10_46*qd[8]
    OMcp10_27 = OMcp10_26+ROcp10_56*qd[8]
    OMcp10_37 = OMcp10_36+ROcp10_66*qd[8]
    ...
    OPcp10_17 = OPcp10_16+ROcp10_46*qdd[8]+qd[8]*(OMcp10_26*ROcp10_66-OMcp10_36*ROcp10_56)
    OPcp10_27 = OPcp10_26+ROcp10_56*qdd[8]+qd[8]*(-OMcp10_16*ROcp10_66+OMcp10_36*ROcp10_46)
    OPcp10_37 = OPcp10_36+ROcp10_66*qdd[8]+qd[8]*(OMcp10_16*ROcp10_56-OMcp10_26*ROcp10_46)
    ...
    RLcp10_18 = ROcp10_18*s.dpt[1,5]
    RLcp10_28 = ROcp10_28*s.dpt[1,5]
    RLcp10_38 = ROcp10_38*s.dpt[1,5]
    ...
    OMcp10_18 = OMcp10_17+ROcp10_46*qd[9]
    OMcp10_28 = OMcp10_27+ROcp10_56*qd[9]
    OMcp10_38 = OMcp10_37+ROcp10_66*qd[9]
    ...
    OPcp10_18 = OPcp10_17+ROcp10_46*qdd[9]+qd[9]*(OMcp10_27*ROcp10_66-OMcp10_37*ROcp10_56)
    OPcp10_28 = OPcp10_27+ROcp10_56*qdd[9]+qd[9]*(-OMcp10_17*ROcp10_66+OMcp10_37*ROcp10_46)
    OPcp10_38 = OPcp10_37+ROcp10_66*qdd[9]+qd[9]*(OMcp10_17*ROcp10_56-OMcp10_27*ROcp10_46)
    ...
    RLcp10_19 = ROcp10_19*s.dpt[1,8]+ROcp10_79*s.dpt[3,8]
    RLcp10_29 = ROcp10_29*s.dpt[1,8]+ROcp10_89*s.dpt[3,8]
    RLcp10_39 = ROcp10_39*s.dpt[1,8]+ROcp10_99*s.dpt[3,8]
    ...
    OMcp10_19 = OMcp10_18+ROcp10_46*qd[10]
    OMcp10_29 = OMcp10_28+ROcp10_56*qd[10]
    OMcp10_39 = OMcp10_38+ROcp10_66*qd[10]
    ...
    OPcp10_19 = OPcp10_18+ROcp10_46*qdd[10]+qd[10]*(OMcp10_28*ROcp10_66-OMcp10_38*ROcp10_56)
    OPcp10_29 = OPcp10_28+ROcp10_56*qdd[10]+qd[10]*(-OMcp10_18*ROcp10_66+OMcp10_38*ROcp10_46)
    OPcp10_39 = OPcp10_38+ROcp10_66*qdd[10]+qd[10]*(OMcp10_18*ROcp10_56-OMcp10_28*ROcp10_46)
