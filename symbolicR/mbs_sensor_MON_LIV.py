...
# Sensor Kinematics
  ...
  if (isens == 1): 
    ...
    ROcp1_18 = ROcp1_17*C8+ROcp1_46*S8
    ROcp1_28 = ROcp1_27*C8+ROcp1_56*S8
    ROcp1_38 = ROcp1_37*C8+ROcp1_66*S8
    ROcp1_48 = -ROcp1_17*S8+ROcp1_46*C8
    ROcp1_58 = -ROcp1_27*S8+ROcp1_56*C8
    ROcp1_68 = -ROcp1_37*S8+ROcp1_66*C8
    OMcp1_25 = qd[5]*C4
    OMcp1_35 = qd[5]*S4
  ...
  if (isens == 4): 
    ...
    ROcp4_111 = ROcp4_16*C11-S11*S5
    ROcp4_211 = ROcp4_26*C11-ROcp4_85*S11
    ROcp4_311 = ROcp4_36*C11-ROcp4_95*S11
    ROcp4_711 = ROcp4_16*S11+C11*S5
    ROcp4_811 = ROcp4_26*S11+ROcp4_85*C11
    ROcp4_911 = ROcp4_36*S11+ROcp4_95*C11
    ROcp4_112 = ROcp4_111*C12+ROcp4_46*S12
    ROcp4_212 = ROcp4_211*C12+ROcp4_56*S12
    ROcp4_312 = ROcp4_311*C12+ROcp4_66*S12
    ROcp4_412 = -ROcp4_111*S12+ROcp4_46*C12
    ROcp4_512 = -ROcp4_211*S12+ROcp4_56*C12
    ROcp4_612 = -ROcp4_311*S12+ROcp4_66*C12
    OMcp4_25 = qd[5]*C4
    OMcp4_35 = qd[5]*S4
    ...
    OMcp4_17 = OMcp4_16+ROcp4_46*qd[11]
    OMcp4_27 = OMcp4_26+ROcp4_56*qd[11]
    OMcp4_37 = OMcp4_36+ROcp4_66*qd[11]
    ...
    OPcp4_17 = OPcp4_16+ROcp4_46*qdd[11]+qd[11]*(OMcp4_26*ROcp4_66-OMcp4_36*ROcp4_56)
    OPcp4_27 = OPcp4_26+ROcp4_56*qdd[11]+qd[11]*(-OMcp4_16*ROcp4_66+OMcp4_36*ROcp4_46)
    OPcp4_37 = OPcp4_36+ROcp4_66*qdd[11]+qd[11]*(OMcp4_16*ROcp4_56-OMcp4_26*ROcp4_46)
