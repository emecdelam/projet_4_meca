...
# Sensor Kinematics
  ...
  if (isens == 1): 
    ...
    OPcp1_18 = OPcp1_17+ROcp1_77*qdd[8]+qd[8]*(OMcp1_27*ROcp1_97-OMcp1_37*ROcp1_87)
    OPcp1_28 = OPcp1_27+ROcp1_87*qdd[8]+qd[8]*(-OMcp1_17*ROcp1_97+OMcp1_37*ROcp1_77)
    OPcp1_38 = OPcp1_37+ROcp1_97*qdd[8]+qd[8]*(OMcp1_17*ROcp1_87-OMcp1_27*ROcp1_77)
    sens.P[1] = POcp1_17
    sens.P[2] = POcp1_27
    sens.P[3] = POcp1_37
    sens.R[1,1] = ROcp1_18
  ...
  if (isens == 2): 
    ...
    ROcp2_49 = ROcp2_46*C9+S5*S9
    ROcp2_59 = ROcp2_56*C9+ROcp2_85*S9
    ROcp2_69 = ROcp2_66*C9+ROcp2_95*S9
    ROcp2_79 = -ROcp2_46*S9+S5*C9
    ROcp2_89 = -ROcp2_56*S9+ROcp2_85*C9
    ROcp2_99 = -ROcp2_66*S9+ROcp2_95*C9
    OMcp2_25 = qd[5]*C4
    OMcp2_35 = qd[5]*S4
    ...
    OMcp2_17 = OMcp2_16+ROcp2_16*qd[9]
    OMcp2_27 = OMcp2_26+ROcp2_26*qd[9]
    OMcp2_37 = OMcp2_36+ROcp2_36*qd[9]
    ...
    OPcp2_17 = OPcp2_16+ROcp2_16*qdd[9]+qd[9]*(OMcp2_26*ROcp2_36-OMcp2_36*ROcp2_26)
    OPcp2_27 = OPcp2_26+ROcp2_26*qdd[9]+qd[9]*(-OMcp2_16*ROcp2_36+OMcp2_36*ROcp2_16)
    OPcp2_37 = OPcp2_36+ROcp2_36*qdd[9]+qd[9]*(OMcp2_16*ROcp2_26-OMcp2_26*ROcp2_16)
  ...
  if (isens == 3): 
    ...
    ROcp3_410 = ROcp3_46*C10+S10*S5
    ROcp3_510 = ROcp3_56*C10+ROcp3_85*S10
    ROcp3_610 = ROcp3_66*C10+ROcp3_95*S10
    ROcp3_710 = -ROcp3_46*S10+C10*S5
    ROcp3_810 = -ROcp3_56*S10+ROcp3_85*C10
    ROcp3_910 = -ROcp3_66*S10+ROcp3_95*C10
    OMcp3_25 = qd[5]*C4
    OMcp3_35 = qd[5]*S4
    ...
    OMcp3_17 = OMcp3_16+ROcp3_16*qd[10]
    OMcp3_27 = OMcp3_26+ROcp3_26*qd[10]
    OMcp3_37 = OMcp3_36+ROcp3_36*qd[10]
    ...
    OPcp3_17 = OPcp3_16+ROcp3_16*qdd[10]+qd[10]*(OMcp3_26*ROcp3_36-OMcp3_36*ROcp3_26)
    OPcp3_27 = OPcp3_26+ROcp3_26*qdd[10]+qd[10]*(-OMcp3_16*ROcp3_36+OMcp3_36*ROcp3_16)
    OPcp3_37 = OPcp3_36+ROcp3_36*qdd[10]+qd[10]*(OMcp3_16*ROcp3_26-OMcp3_26*ROcp3_16)
  ...
  if (isens == 4): 
    ...
    ROcp4_411 = ROcp4_46*C11+S11*S5
    ROcp4_511 = ROcp4_56*C11+ROcp4_85*S11
    ROcp4_611 = ROcp4_66*C11+ROcp4_95*S11
    ROcp4_711 = -ROcp4_46*S11+C11*S5
    ROcp4_811 = -ROcp4_56*S11+ROcp4_85*C11
    ROcp4_911 = -ROcp4_66*S11+ROcp4_95*C11
    ROcp4_112 = ROcp4_16*C12+ROcp4_411*S12
    ROcp4_212 = ROcp4_26*C12+ROcp4_511*S12
    ROcp4_312 = ROcp4_36*C12+ROcp4_611*S12
    ROcp4_412 = -ROcp4_16*S12+ROcp4_411*C12
    ROcp4_512 = -ROcp4_26*S12+ROcp4_511*C12
    ROcp4_612 = -ROcp4_36*S12+ROcp4_611*C12
    OMcp4_25 = qd[5]*C4
    OMcp4_35 = qd[5]*S4
    ...
    OMcp4_17 = OMcp4_16+ROcp4_16*qd[11]
    OMcp4_27 = OMcp4_26+ROcp4_26*qd[11]
    OMcp4_37 = OMcp4_36+ROcp4_36*qd[11]
    ...
    OPcp4_17 = OPcp4_16+ROcp4_16*qdd[11]+qd[11]*(OMcp4_26*ROcp4_36-OMcp4_36*ROcp4_26)
    OPcp4_27 = OPcp4_26+ROcp4_26*qdd[11]+qd[11]*(-OMcp4_16*ROcp4_36+OMcp4_36*ROcp4_16)
    OPcp4_37 = OPcp4_36+ROcp4_36*qdd[11]+qd[11]*(OMcp4_16*ROcp4_26-OMcp4_26*ROcp4_16)
    ...
    OMcp4_18 = OMcp4_17+ROcp4_711*qd[12]
    OMcp4_28 = OMcp4_27+ROcp4_811*qd[12]
    OMcp4_38 = OMcp4_37+ROcp4_911*qd[12]
    OPcp4_18 = OPcp4_17+ROcp4_711*qdd[12]+qd[12]*(OMcp4_27*ROcp4_911-OMcp4_37*ROcp4_811)
    OPcp4_28 = OPcp4_27+ROcp4_811*qdd[12]+qd[12]*(-OMcp4_17*ROcp4_911+OMcp4_37*ROcp4_711)
    OPcp4_38 = OPcp4_37+ROcp4_911*qdd[12]+qd[12]*(OMcp4_17*ROcp4_811-OMcp4_27*ROcp4_711)
    sens.P[1] = POcp4_17
    sens.P[2] = POcp4_27
    sens.P[3] = POcp4_37
    ...
    sens.R[2,1] = ROcp4_412
    sens.R[2,2] = ROcp4_512
    sens.R[2,3] = ROcp4_612
    sens.R[3,1] = ROcp4_711
    sens.R[3,2] = ROcp4_811
    sens.R[3,3] = ROcp4_911
    sens.V[1] = VIcp4_17
    sens.V[2] = VIcp4_27
    sens.V[3] = VIcp4_37
    sens.OM[1] = OMcp4_18
