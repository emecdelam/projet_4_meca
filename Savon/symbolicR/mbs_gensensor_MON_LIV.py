...
# Sensor Kinematics
  ...
  if (isens == 7): 
    ...
    ROcp7_17 = ROcp7_16*C7+ROcp7_46*S7
    ROcp7_27 = ROcp7_26*C7+ROcp7_56*S7
    ROcp7_37 = ROcp7_36*C7+ROcp7_66*S7
    ROcp7_47 = -ROcp7_16*S7+ROcp7_46*C7
    ROcp7_57 = -ROcp7_26*S7+ROcp7_56*C7
    ROcp7_67 = -ROcp7_36*S7+ROcp7_66*C7
    OMcp7_25 = qd[5]*C4
    OMcp7_35 = qd[5]*S4
    ...
    OMcp7_17 = OMcp7_16+qd[7]*S5
    OMcp7_27 = OMcp7_26+ROcp7_85*qd[7]
    OMcp7_37 = OMcp7_36+ROcp7_95*qd[7]
    ...
    OPcp7_17 = OPcp7_16+qdd[7]*S5+qd[7]*(OMcp7_26*ROcp7_95-OMcp7_36*ROcp7_85)
    OPcp7_27 = OPcp7_26+ROcp7_85*qdd[7]+qd[7]*(-OMcp7_16*ROcp7_95+OMcp7_36*S5)
    OPcp7_37 = OPcp7_36+ROcp7_95*qdd[7]+qd[7]*(OMcp7_16*ROcp7_85-OMcp7_26*S5)
  ...
  if (isens == 8): 
    ...
    ROcp8_17 = ROcp8_16*C7+ROcp8_46*S7
    ROcp8_27 = ROcp8_26*C7+ROcp8_56*S7
    ROcp8_37 = ROcp8_36*C7+ROcp8_66*S7
    ROcp8_47 = -ROcp8_16*S7+ROcp8_46*C7
    ROcp8_57 = -ROcp8_26*S7+ROcp8_56*C7
    ROcp8_67 = -ROcp8_36*S7+ROcp8_66*C7
    ROcp8_18 = ROcp8_17*C8-S5*S8
    ROcp8_28 = ROcp8_27*C8-ROcp8_85*S8
    ROcp8_38 = ROcp8_37*C8-ROcp8_95*S8
    ROcp8_78 = ROcp8_17*S8+S5*C8
    ROcp8_88 = ROcp8_27*S8+ROcp8_85*C8
    ROcp8_98 = ROcp8_37*S8+ROcp8_95*C8
    OMcp8_25 = qd[5]*C4
    OMcp8_35 = qd[5]*S4
    ...
    OMcp8_17 = OMcp8_16+qd[7]*S5
    OMcp8_27 = OMcp8_26+ROcp8_85*qd[7]
    OMcp8_37 = OMcp8_36+ROcp8_95*qd[7]
    ...
    OPcp8_17 = OPcp8_16+qdd[7]*S5+qd[7]*(OMcp8_26*ROcp8_95-OMcp8_36*ROcp8_85)
    OPcp8_27 = OPcp8_26+ROcp8_85*qdd[7]+qd[7]*(-OMcp8_16*ROcp8_95+OMcp8_36*S5)
    OPcp8_37 = OPcp8_36+ROcp8_95*qdd[7]+qd[7]*(OMcp8_16*ROcp8_85-OMcp8_26*S5)
  ...
  if (isens == 11): 
    ...
    ROcp11_111 = ROcp11_16*C11+ROcp11_46*S11
    ROcp11_211 = ROcp11_26*C11+ROcp11_56*S11
    ROcp11_311 = ROcp11_36*C11+ROcp11_66*S11
    ROcp11_411 = -ROcp11_16*S11+ROcp11_46*C11
    ROcp11_511 = -ROcp11_26*S11+ROcp11_56*C11
    ROcp11_611 = -ROcp11_36*S11+ROcp11_66*C11
    OMcp11_25 = qd[5]*C4
    OMcp11_35 = qd[5]*S4
    ...
    OMcp11_17 = OMcp11_16+qd[11]*S5
    OMcp11_27 = OMcp11_26+ROcp11_85*qd[11]
    OMcp11_37 = OMcp11_36+ROcp11_95*qd[11]
    ...
    OPcp11_17 = OPcp11_16+qdd[11]*S5+qd[11]*(OMcp11_26*ROcp11_95-OMcp11_36*ROcp11_85)
    OPcp11_27 = OPcp11_26+ROcp11_85*qdd[11]+qd[11]*(-OMcp11_16*ROcp11_95+OMcp11_36*S5)
    OPcp11_37 = OPcp11_36+ROcp11_95*qdd[11]+qd[11]*(OMcp11_16*ROcp11_85-OMcp11_26*S5)
    ...
    sens.R[3,1] = S5
    sens.R[3,2] = ROcp11_85
    sens.R[3,3] = ROcp11_95
    sens.V[1] = VIcp11_17
    sens.V[2] = VIcp11_27
    sens.V[3] = VIcp11_37
    sens.OM[1] = OMcp11_17
    ...
    sens.J[5,11] = ROcp11_85
    sens.J[6,5] = S4
    sens.J[6,6] = ROcp11_95
    sens.J[6,11] = ROcp11_95
    sens.A[1] = ACcp11_17
    sens.A[2] = ACcp11_27
    sens.A[3] = ACcp11_37
  ...
  if (isens == 12): 
    ...
    ROcp12_111 = ROcp12_16*C11+ROcp12_46*S11
    ROcp12_211 = ROcp12_26*C11+ROcp12_56*S11
    ROcp12_311 = ROcp12_36*C11+ROcp12_66*S11
    ROcp12_411 = -ROcp12_16*S11+ROcp12_46*C11
    ROcp12_511 = -ROcp12_26*S11+ROcp12_56*C11
    ROcp12_611 = -ROcp12_36*S11+ROcp12_66*C11
    ROcp12_112 = ROcp12_111*C12-S12*S5
    ROcp12_212 = ROcp12_211*C12-ROcp12_85*S12
    ROcp12_312 = ROcp12_311*C12-ROcp12_95*S12
    ROcp12_712 = ROcp12_111*S12+C12*S5
    ROcp12_812 = ROcp12_211*S12+ROcp12_85*C12
    ROcp12_912 = ROcp12_311*S12+ROcp12_95*C12
    OMcp12_25 = qd[5]*C4
    OMcp12_35 = qd[5]*S4
    ...
    OMcp12_17 = OMcp12_16+qd[11]*S5
    OMcp12_27 = OMcp12_26+ROcp12_85*qd[11]
    OMcp12_37 = OMcp12_36+ROcp12_95*qd[11]
    ...
    OPcp12_17 = OPcp12_16+qdd[11]*S5+qd[11]*(OMcp12_26*ROcp12_95-OMcp12_36*ROcp12_85)
    OPcp12_27 = OPcp12_26+ROcp12_85*qdd[11]+qd[11]*(-OMcp12_16*ROcp12_95+OMcp12_36*S5)
    OPcp12_37 = OPcp12_36+ROcp12_95*qdd[11]+qd[11]*(OMcp12_16*ROcp12_85-OMcp12_26*S5)
    ...
    sens.J[5,11] = ROcp12_85
    sens.J[5,12] = ROcp12_511
    sens.J[6,5] = S4
    sens.J[6,6] = ROcp12_95
    sens.J[6,11] = ROcp12_95
